  ...
  <div class="box">
    ...
    <div class="register flex-c" v-else>
      ...
      <div class="wrap flex-c" v-if="step == 1">
        <input type="text" v-model="registerSno" placeholder="你的杭电学号是什么呀">
        <input type="password" v-model="registerPassword" placeholder="必须由6-18位字母、数字组成">
        <input type="text" v-model="registerEmail" placeholder="还可以使用邮箱登录哦">
        <div :class="{'next-btn':true, 'gray': !registerFull}" @click="checkAll">下一步</div>
      </div>
